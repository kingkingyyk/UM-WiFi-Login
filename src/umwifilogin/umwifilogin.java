...
public class umwifilogin {
	...
	public static void CreateTrayIcon() {
		...
		MenuItem login=new MenuItem("Trigger Login");
	...
	public static void tryLogin() {
		try {
			...
			if (s!=null && s.contains("unified.um.edu.my")) {
				...
				s=s.replace("<script>top.self.location.href='https://unified.um.edu.my/eportal/index.jsp?","").replaceAll("'</script>","");
